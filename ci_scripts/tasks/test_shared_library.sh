...
timestamp=$(date +%s)
result_bundle_path="$results_directory/TestResults_FluelLibrary_${timestamp}.xcresult"
...
echo "Finished FluelLibrary tests. Result bundle: $result_bundle_path"
